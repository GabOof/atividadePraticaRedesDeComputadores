...
def run_server():
    import atividadePratica3.servidor3 as servidor3  # Assumindo que o servidor está no arquivo 'servidor2.py'

    servidor3.main()  # Executa a função main do servidor


def run_cliente(cliente_id):
    import atividadePratica3.cliente3 as cliente3  # Assumindo que o cliente está no arquivo 'cliente2.py'

    cliente3.client_task(cliente_id)  # Executa a tarefa do cliente com o ID fornecido
